  ...
  return (
    <div className='flex items-center gap-2'>
      ...
      <RadixSwitch.Root
        id={id}
        checked={isOn}
        className='relative h-4 w-8 cursor-default bg-yellow-500/40 shadow-[0_2px_10px] shadow-black outline-none focus:shadow-[0_0_0_2px] focus:shadow-yellow-500/50 data-[state=checked]:bg-yellow-500 focus:data-[state=checked]:shadow-yellow-500/50'
