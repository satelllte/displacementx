...
export function Switch({isOn, setIsOn}: SwitchProps) {
  return (
    <RadixSwitch.Root
      checked={isOn}
      className='bg-pink/50 outline-hidden focus:shadow-sky data-[state=checked]:bg-pink relative h-4 w-8 cursor-default shadow-[0_2px_10px] shadow-black focus:shadow-[0_0_0_2px]'
