  ...
  return (
    <div className='flex items-center gap-2'>
      ...
      <RadixSwitch.Root
        id={id}
        checked={isOn}
        className='focus:shadow-sky data-[state=checked]:bg-pink bg-pink/50 relative h-4 w-8 cursor-default shadow-[0_2px_10px] shadow-black outline-none focus:shadow-[0_0_0_2px]'
