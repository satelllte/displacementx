  ...
  return (
    <div className='flex items-center gap-2'>
      ...
      <RadixSwitch.Root
        id={id}
        checked={isOn}
        className='relative h-4 w-8 cursor-default bg-sky-700 shadow-[0_2px_10px] shadow-black outline-none focus:shadow-[0_0_0_2px] focus:shadow-sky-700/50 data-[state=checked]:bg-pink-700 focus:data-[state=checked]:shadow-pink-700/50'
