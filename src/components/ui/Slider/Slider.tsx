    ...
    <div className='w-full select-none text-sm'>
      ...
      >
        <RadixSlider.Track className='relative block h-1 grow rounded-full bg-white'>
          <RadixSlider.Range className='absolute h-full rounded-full bg-yellow-500' />
        </RadixSlider.Track>
...
function Thumb({id, labelledBy}: ThumbProps) {
  return (
    <RadixSlider.Thumb
      id={id}
      className='block h-3 w-3 bg-white hover:shadow-[0_0_0_2px] hover:shadow-yellow-500 focus:shadow-[0_0_0_2px] focus:shadow-yellow-500 focus:outline-none'
